...
void test_get_pwm_act(void) { TEST_ASSERT_EQUAL(0, get_pwm_act()); }

void test_get_output(void) { TEST_ASSERT_EQUAL(0, get_output()); }

void test_get_int_cmd(void) { TEST_ASSERT_EQUAL(0, get_int_cmd()); }

void test_get_prop_cmd(void) { TEST_ASSERT_EQUAL(0, get_prop_cmd()); }

void test_get_pi_error(void) { TEST_ASSERT_EQUAL(0, get_pi_error()); }

void test_get_RPM_act(void) { TEST_ASSERT_EQUAL(0, get_RPM_act()); }

void test_get_RPM_raw(void) { TEST_ASSERT_EQUAL(0, get_RPM_raw()); }

void test_getSpeedAct(void) { TEST_ASSERT_EQUAL(0, getSpeedAct()); }
...
void test_check_for_large_error(void) { TEST_ASSERT_EQUAL(0, check_for_large_error()); }
...
void test_get_RPM_raw_10Hz(void) { TEST_ASSERT_EQUAL(0, get_RPM_raw_10Hz()); }
