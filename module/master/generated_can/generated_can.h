...
typedef struct {
  ...
  uint8_t MOTOR_DATA_direction : 2;  ///< B25:24   Destination: MASTER,BRIDGE
...
/// Not generating code for dbc_decode_GEO_COORDINATE_DATA() since 'MASTER' is not the recipient of any of the signals
