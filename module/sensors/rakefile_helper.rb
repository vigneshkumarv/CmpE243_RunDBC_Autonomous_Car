require 'yaml'
require 'fileutils'
require '../../third_party/unity_cmock/vendor/unity/auto/unity_test_summary'
require '../../third_party/unity_cmock/vendor/unity/auto/generate_test_runner'
require '../../third_party/unity_cmock/vendor/unity/auto/colour_reporter'
  ...
  def run_tests(test_files)
    ...
    test_files.each do |test|
      ...
      header_list.each do |header|
        ...
        if (header =~ /Mock/)
          require "../../third_party/unity_cmock/lib/cmock.rb"
