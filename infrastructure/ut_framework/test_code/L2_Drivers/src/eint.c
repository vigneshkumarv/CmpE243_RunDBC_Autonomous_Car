 ...
 */
static void eint3_enable(uint8_t pin_num, eint_intr_t type, void_func_t func, eint3_entry_t **list_head_ptr,
                         volatile uint32_t *int_en_reg_ptr) {
...
void eint3_enable_port0(uint8_t pin_num, eint_intr_t type, void_func_t func) {
  eint3_enable(pin_num, type, func, (eint_rising_edge == type) ? &gp_port0_rising_list : &gp_port0_falling_list,
...
void eint3_enable_port2(uint8_t pin_num, eint_intr_t type, void_func_t func) {
  eint3_enable(pin_num, type, func, (eint_rising_edge == type) ? &gp_port2_rising_list : &gp_port2_falling_list,
