...
unsigned ssp1_dma_transfer_block(unsigned char *pBuffer, uint32_t num_bytes, char is_write_op) {
  ...
  LPC_GPDMACH_TypeDef *pDmaRxChannel = (LPC_GPDMACH_TypeDef *)(LPC_GPDMACH0_BASE + SPI_DMA_RX_NUM * 0x20);
  LPC_GPDMACH_TypeDef *pDmaTxChannel = (LPC_GPDMACH_TypeDef *)(LPC_GPDMACH0_BASE + SPI_DMA_TX_NUM * 0x20);
